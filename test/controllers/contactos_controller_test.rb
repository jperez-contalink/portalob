...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { correo: @contacto.correo, titulo: @contacto.titulo, usuario_id: @contacto.usuario_id }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { correo: @contacto.correo, titulo: @contacto.titulo, usuario_id: @contacto.usuario_id }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
