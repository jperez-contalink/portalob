  ...
  module V1
    class DocumentoscobranzasController < ApplicationController
      ...
      def index
        ...
        order_link = "http://" + @user.empresa.usuariosob + ":" + @user.empresa.passob + "@" + @user.empresa.urlwebservice + "/openbravo/org.openbravo.service.json.jsonrest/pob_documentocobranza?_where=taxid=%27" + @user.rfc + "%27&orderBy=dateinvoiced"
        puts order_link
