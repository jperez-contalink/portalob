  ...
  module V1
    class AplicarcobranzasController < ApplicationController
      ...
      def index
        ...
        order_link = "http://" + @user.empresa.usuariosob + ":" + @user.empresa.passob + "@" + @user.empresa.urlwebservice + "/openbravo/ws/com.tegik.portalob.AplicaCobranzaPortal?docs=" + params[:lineas] + "&mets=" + params[:metodos] + "&bpuid=" + @user.partner_id
        puts order_link 
