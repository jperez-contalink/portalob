  ...
  module V1
    class AplicarcobranzasController < ApplicationController
      ...
      def index
        ...
        #order_link = "http://" + @user.empresa.usuariosob + ":" + @user.empresa.passob + "@" + @user.empresa.urlwebservice + "/openbravo/ws/com.tegik.portalob.AplicaCobranzaPortal?docs=id_345.45&rfc=ASJ9810288T9"
        puts order_link 
