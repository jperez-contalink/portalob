  ...
  module V1
    class ReporteFacturasController < ApplicationController
      ...
      def index
        ...
        order_link = "http://" + @user.empresa.usuariosob + ":" + @user.empresa.passob + "@" + @user.empresa.urlwebservice + "/openbravo/org.openbravo.service.json.jsonrest/POB_VistaFacturasPortal?_where=bpartner=%27" + @user.partner_id + "%27"
